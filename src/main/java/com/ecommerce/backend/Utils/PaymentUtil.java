...
public class PaymentUtil {
	 private static final String paymentKey = "gtKFFx";
	    ...
	    private static final String sUrl = "http://localhost:8087/payment/payment-response";

	    private static final String fUrl = "http://localhost:8087/payment/payment-response";
